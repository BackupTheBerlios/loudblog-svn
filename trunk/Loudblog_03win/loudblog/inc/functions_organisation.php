...
echo "\" onSubmit=\"return yesno('Do you really want to delete this author? She/He might be angry about that!')\">\n";
...
foreach ($cats as $showcat) {
    ...
    //show delete button
    echo "<td class=\"right\"><input onClick=\"return yesno('Do you really want to delete this category?')\" type=\"submit\" value=\"delete\" ";
