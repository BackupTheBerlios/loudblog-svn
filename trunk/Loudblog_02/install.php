...
echo "    </td>\n";
echo "    <td class=\"right\">\n";
echo "    Address of your Loudblog-powered audioblog or podcast. Without trailing slash! Example:<br /><code>http://www.mikeswebsite.com</code>";
echo "    </td>\n";
echo "</tr>\n\n";
...
echo "<p>Unfortunately, if you want to use CGI for uploading audio data, you have to set some further permissions.</p>";
echo "<ul>\n<li>set \"loudblog/modules/cgi-bin\" to \"chmod 777\"</li>\n";
echo "<li>set \"loudblog/modules/cgi-bin/upload.php\" to \"chmod 755\"</li>\n";
echo "<li>set \"loudblog/modules/cgi-bin/download.php\" to \"chmod 755\"</li>\n</ul>\n\n";

echo "<p>CGI-Uploading is not necessary, but very useful. Check if your server is able to execute CGI scripts!</p>";

//get the permission of the folders
if ((fileperms(getcwd()."/upload") == 16895) AND (fileperms(getcwd()."/audio") == 16895)) {

echo "<h2>audio/upload permissions are okay now!</h2>\n";
