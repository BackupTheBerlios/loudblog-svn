...
if ($string != "") {
    ...
    $string = str_replace('href="/', '2764rtte24dh="/', $string);
    $string = str_replace('href="index.php', '2764rtte24dh="index.php', $string);
    $string = str_replace('href="podcast.php', '2764rtte24dh="podcast.php', $string);
