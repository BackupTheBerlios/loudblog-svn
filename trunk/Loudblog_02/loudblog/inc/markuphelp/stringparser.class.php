...
class StringParser {
	 ...
	 *
	 * @access public
	 * @var int $type The type of the filter
	 * @var mixed $callback The callback to call
	 * @return bool
	 ...
	 *
	 * @access public
	 * @var int $type The type of the filter or 0 for all
	 * @return bool
	 * @see STRINGPARSER_FILTER_PRE, STRINGPARSER_FILTER_POST
	 */
...
class StringParser_Node_Text extends StringParser_Node {
	...
	function StringParser_Node_Text ($content, $occurredAt = -1) {
		parent::StringParser_Node ($content, $occurredAt);
