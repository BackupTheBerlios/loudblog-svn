...
$dosql = array( 
"INSERT INTO `".$lb_pref."lb_settings` (`name`,`value`) VALUES (\"ftp\",\"0\")",
"INSERT INTO `".$lb_pref."lb_settings` (`name`,`value`) VALUES (\"ftp_server\",\"\")",
"INSERT INTO `".$lb_pref."lb_settings` (`name`,`value`) VALUES (\"ftp_user\",\"\")",
"INSERT INTO `".$lb_pref."lb_settings` (`name`,`value`) VALUES (\"ftp_pass\",\"\")",
"INSERT INTO `".$lb_pref."lb_settings` (`name`,`value`) VALUES (\"ftp_path\",\"\")",
"INSERT INTO `".$lb_pref."lb_settings` (`name`,`value`) VALUES (\"cgi\",\"0\")",
"INSERT INTO `".$lb_pref."lb_settings` (`name`,`value`) VALUES (\"cgi_url\",\"http://\")",
"INSERT INTO `".$lb_pref."lb_settings` (`name`,`value`) VALUES (\"cgi_local\",\"0\");");

foreach ($dosql as $sql) {
$result = mysql_query($sql) OR die (mysql_error());
}

echo "<p>Updating was successful! Now please delete install.php and update01-02.php!</p>";
